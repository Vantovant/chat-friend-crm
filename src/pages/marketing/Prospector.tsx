...
const FLOW = [
  ...
  { n: '03', icon: Bot, color: 'hsl(var(--brand-orange))', title: 'Unified Trust first-touch', body: 'The Prospector replies in under 30 seconds with a trust-first intro: identity ("Vanto from GetWellAfrica — accredited APLGO distributor"), a single qualifying question, and a menu of options.' },
