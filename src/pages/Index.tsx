...
const GroupScoreboardModule = lazy(() => import('@/components/vanto/GroupScoreboardModule').then(m => ({ default: m.GroupScoreboardModule })));
...
const Index = () => {
  ...
  const renderModule = () => {
    switch (activeModule) {
      ...
      case 'group-scoreboard': return <GroupScoreboardModule />;
