...
export type Module = 'dashboard' | 'inbox' | 'maytapi-inbox' | 'maytapi-unmatched' | 'contacts' | 'crm' | 'automations' | 'ai-agent' | 'knowledge' | 'playbooks' | 'workflows' | 'integrations' | 'api-console' | 'settings' | 'group-campaigns' | 'group-administrator' | 'review-queue' | 'damage-control' | 'prospector-drafts';
