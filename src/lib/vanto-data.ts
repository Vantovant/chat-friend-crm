...
export type Module = 'dashboard' | 'inbox' | 'maytapi-inbox' | 'maytapi-unmatched' | 'facebook-inbox' | 'group-inbox' | 'group-scoreboard' | 'contacts' | 'crm' | 'automations' | 'ai-agent' | 'knowledge' | 'playbooks' | 'workflows' | 'integrations' | 'api-console' | 'settings' | 'group-campaigns' | 'group-administrator' | 'review-queue' | 'reports' | 'prospector-drafts' | 'plan' | 'voice-diary' | 'backlink-outreach' | 'client-nurture' | 'reactivation-campaign';
