...
- [Facebook Page Connections](mem://features/facebook-page-connections) — Per-user FB Page OAuth, per-page token resolution, inbox scoping
...
- [Master Prospector Level 1](mem://features/master-prospector-level1) — Awake in supervised draft-only mode via zazi-copilot; trust-first first-touch enforced; no auto-send/bulk/cron expansion; suggestions stamped with prospector reason block
- [Master Prospector Level 2A](mem://features/master-prospector-level2a) — Auto first-touch only on Twilio+Maytapi; everything else drafts to ai_suggestions for Prospector Drafts approval; DNC + quiet hours 22:00-06:00 SAST + hourly cap 30 enforced; rollback SQL provided
