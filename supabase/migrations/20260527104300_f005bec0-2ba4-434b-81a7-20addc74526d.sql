...
DROP TRIGGER IF EXISTS enforce_scheduled_group_safety_trigger ON public.scheduled_group_posts;
CREATE TRIGGER enforce_scheduled_group_safety_trigger
BEFORE INSERT OR UPDATE OF target_group_name, message_content, status
